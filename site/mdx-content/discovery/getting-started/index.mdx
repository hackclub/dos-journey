...
console.log("People have asked if I'm an awesome hack clubber, and to that I say it is " + isAnAwesomeHackClubber + " 😎");
    ...
    *Heidi scurries away on all four paws, leaving paper trailing in her wake.* 
    ...
    <Tip title="Screen too small?">Did you know you can click the <span class = "underline underline-offset-4 decoration-wavy">expand</span> button in the top left corner to make this screen bigger?</Tip>
